...
- 앞서 살펴보았듯 **객체는 상태를 나타내는 프로퍼티와 동작을 나타내는 메서드를 하나의 논리적인 단위로 붂은 복합적인 자료구조 입니다.**
- **객체는 상태를 나타내는 프로퍼티와 동작을 나타내는 메서드를 하나의 논리적인 단위로 붂은 복합적인 자료구조 입니다.**
- **객체는 상태를 나타내는 프로퍼티와 동작을 나타내는 메서드를 하나의 논리적인 단위로 붂은 복합적인 자료구조 입니다.**
- **객체는 상태를 나타내는 프로퍼티와 동작을 나타내는 메서드를 하나의 논리적인 단위로 붂은 복합적인 자료구조 입니다.**
- **객체는 상태를 나타내는 프로퍼티와 동작을 나타내는 메서드를 하나의 논리적인 단위로 붂은 복합적인 자료구조 입니다.**
...
- **이처럼 코드가 실행되려염 아래와 같이 스코프, 식별자, 코드 실행 순서 등의 관리가 필요합니다**
  1. 선언에 의해 생성된 모든 식별자(변수 함수 클래스 등)를 구분하여 등록하고 상태 변화(식별자에 바인딩된 값의 변화)를 지속적으로 관리할 수 있ㅇ야 합니다.
